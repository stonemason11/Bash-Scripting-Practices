...
String format descripton based on : ls (GNU fileutils_ version 4.0.36

Produces a line (or more) formatted:
inode permissions hard-links ower group ...
32736 -rw------- 1 mszick mszick

size	day month date hh:mm:ss year path
2756608 Sun Apr    20   08:53:06  2003 /home/mszick/core

Unless it is formated:
...
IndexList()
{
	...
	local -i Lidx Lcnt
	local -i if=0 of=0	# Default to variable name
	...
	do
		...
		then
			...
			*) ((Lidx+=12)) ;; 	#Anythingelse device	
			...
			l)  ((Lidx+=1)) ;;	# AT LEAST two more fields
# A little more elegance here would handle pipes
#+ sockets, delete files - later.
...
# Uncomment above two lines if system has "stat" command installed.
	LOC=( ${LOC1[@]:0:1} ${LOC1[@]:3:11} ${LOC2[@]:1:2} ${LOC2[@]:4:1} )
	case "$of" in
	0) eval $2=\( \"\$\{LOC\[@\]\}\" \) ;;
	1) echo "${LOC[@]}" > "$2" ;;
	esac
...
#Size of array: 15
#Contents of array
#Element 0: /home/mszick20th Century name
#Element 1: 41e8Type and Permissions
#Element 2: 500User
#Element 3: 500Group
#Element 4: 303Device
#Element 5: 32385inode
#Element 6: 22Link count
#Element 7: 0Device Major
#Element 8: 0Device Minor
##
##
##
#Element
...
ListArray() # List Array Name
{
	local -a Ta
	eval Ta=\( \"\$\{$1\[@\]\}\" \)
	echo
	echo "_*_*_ List of Array _*_*_"
